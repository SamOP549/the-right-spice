...
const Footer = () => {
  return (
    <div>
      <footer className="footer p-10 bg-red-800 text-black relative mt-16">
        <div>
          <Image src={logo} alt='logo' height={109 * 1.2} width={150 * 1.2} />
          <p>The Right Spice<br />Providing reliable tech since 1992</p>
        </div>
        <div>
      ...
      <footer className="footer items-center p-4 bg-red-800 text-black">
