...
const Navbar = ({ logout, user, cart, addSpiceToCart, addComboToCart, removeFromCart, clearCart, subTotal, itemCount }) => {
    ...
    useEffect(() => {
        setSidebar(true)
        let excluded = ['/checkout', '/order', '/orders', '/myaccount']
        ...
        <div className='sticky top-0 z-10 shadow-lg'>
            <div className="navbar bg-white text-black">
                ...
                <div className="navbar-end space-x-2">
                    {
                        !showSearchModal &&
                        <button onClick={() => setShowSearchModal(true)} className="btn btn-ghost btn-circle">
                                                    ...
                                                    <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                                                        <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                                            ...
                                                            <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                                                                ...
                                                                <Link href='/checkout'>
                                                                    <div className="mt-6">
                                                                        <button disabled={Object.keys(cart).length === 0} onClick={() => setOpen(false)} className="flex items-center justify-center rounded-md border border-transparent disabled:bg-indigo-300 bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700 w-full">
